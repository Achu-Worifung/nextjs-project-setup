...
export default function ProfileSettingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[rgb(25,30,36)] text-gray-800 dark:text-white">
      <div className="flex flex-col lg:flex-row max-w-7xl mx-auto min-h-screen">
        
        {/* Mobile Header */}
        <div className="lg:hidden shadow-lg dark:shadow-xl bg-gray-50 dark:bg-[rgb(25,30,36)]">
                ...
                <button
                  ...
                  className={`pt-2 flex-shrink-0 flex flex-col items-center gap-2 px-4 py-3 rounded-xl transition-all duration-200 min-w-[80px]
                    ${activeTab === option.key
                      ? "bg-blue-50 text-blue-700 border-2 border-brand-pink-200 shadow-sm dark:bg-[rgb(40,47,54)] dark:text-blue-400 dark:border-brand-pink-700 dark:shadow-md"
                      : "text-gray-600 hover:bg-gray-100 hover:text-gray-900 border-2 border-transparent dark:text-gray-300 dark:hover:bg-[rgb(35,42,49)] dark:hover:text-white"}
                  `}
        ...
        {/* Desktop Sidebar */}
        <aside className="hidden lg:flex w-80 flex-col min-h-screen bg-gray-50 dark:bg-[rgb(25,30,36)] dark:shadow-xl">
          <div className="p-8">
                ...
                <li key={option.key} className="relative">
                  <button
                    className={`w-full flex items-center gap-4 px-4 py-1 rounded-xl transition-all duration-200 group
                      ${activeTab === option.key
                        ? "bg-blue-50 text-blue-700 shadow-sm border border-brand-pink-200 dark:bg-[rgb(40,47,54)] dark:text-blue-400 dark:border-brand-pink-700 dark:shadow-md"
                        : "text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-[rgb(35,42,49)] dark:hover:text-white"}
                    `}
                    onClick={() => setActiveTab(option.key)}
                  >
                    <div className={`p-2 rounded-lg transition-colors ${
                      activeTab === option.key
                        ? "bg-brand-pink-100 dark:bg-brand-pink-900"
                  ...
                  {activeTab === option.key && (
                    <motion.div
                      ...
                      className="absolute left-0 top-0 h-full w-1 bg-blue-500 rounded-r-full dark:bg-blue-400"
        ...
        {/* Main Content */}
        <div className="flex-1 p-1 sm:p-6 lg:p-8 min-h-[400px] lg:min-h-[600px] bg-gray-50 dark:bg-[rgb(25,30,36)]">
