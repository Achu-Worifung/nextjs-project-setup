...
import { CarData, mockAvailableCars } from "@/fake-data/car-rental-data";
...
export default function CarBookingPage() {
  ...
  useEffect(() => {
    ...
    const selectedCar = mockAvailableCars.find(c => c.id === carId);
      ...
      <div className="container mx-auto p-6">
        <div className="bg-red-50 border border-red-200 text-red-700 p-6 rounded-lg flex items-start">
          ...
          <div>
            ...
            <p className="mt-1">We couldn't find the vehicle you're looking for. Please go back and try again.</p>
            <Link 
        ...
        return (
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                <Label htmlFor="cardExpiry" className="mb-1 block">Expiry Date*</Label>
                <input
                  type="text"
                  id="cardExpiry"
                  name="cardExpiry"
              ...
              <div>
                <Label htmlFor="cardCvc" className="mb-1 block">CVC*</Label>
                <input
                  type="text"
                  id="cardCvc"
                  name="cardCvc"
          ...
          <div className="text-center py-8">
            ...
            <div className="p-4 bg-gray-50 rounded-lg text-left mb-6">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <span className="font-medium">{pickupLocation} - {formatDate(pickupDate)}</span>
                <span className="text-gray-600">Return:</span>
                <span className="font-medium">{dropoffLocation} - {formatDate(dropoffDate)}</span>
  ...
  return (
    <div className="container mx-auto p-6">
      <Link href="/car-search-results" className="flex items-center text-gray-600 hover:text-pink-600 mb-6 transition-colors">
        ...
        <div className="w-full lg:w-2/5">
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{pickupLocation || "Not specified"}</p>
                    <p className="text-sm text-gray-500">{formatDate(pickupDate)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{dropoffLocation || "Not specified"}</p>
                    <p className="text-sm text-gray-500">{formatDate(dropoffDate)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{daysCount} {daysCount === 1 ? "day" : "days"}</p>
                  </div>
                </div>
              </div>
              ...
              {/* Insurance Options */}
              <div className="mt-6">
                <h3 className="font-semibold text-gray-900 mb-3">Insurance Options</h3>
                
                <div className="space-y-3">
                  <label className={`block border rounded-lg p-3 cursor-pointer transition-colors ${insuranceOption === 'basic' ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-gray-300'}`}>
                    <div className="flex items-start">
                      <input
                        type="radio"
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Includes liability insurance and collision damage waiver with a $1,000 deductible.</p>
                        <p className="text-sm font-semibold text-gray-900 mt-1">$10/day</p>
                      </div>
                    </div>
                  </label>
                  
                  <label className={`block border rounded-lg p-3 cursor-pointer transition-colors ${insuranceOption === 'premium' ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-gray-300'}`}>
                    <div className="flex items-start">
                      <input
                        type="radio"
                        name="insuranceOption"
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Includes liability insurance, collision damage waiver with a $500 deductible, and tire & windshield protection.</p>
                        <p className="text-sm font-semibold text-gray-900 mt-1">$25/day</p>
                      </div>
                    </div>
                  </label>
                  
                  <label className={`block border rounded-lg p-3 cursor-pointer transition-colors ${insuranceOption === 'full' ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-gray-300'}`}>
                    <div className="flex items-start">
                      <input
                        type="radio"
                        name="insuranceOption"
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Comprehensive coverage with no deductible, includes all protections and roadside assistance.</p>
                        <p className="text-sm font-semibold text-gray-900 mt-1">$40/day</p>
                      </div>
                    </div>
                  </label>
                </div>
              ...
              <div className="mt-6 pt-4 border-t">
                <div className="flex justify-between mb-2">
                  <span className="text-gray-600">Car Rental ({daysCount} {daysCount === 1 ? "day" : "days"})</span>
                ...
                {insuranceOption === 'full' && (
                  <div className="flex justify-between mb-2">
                    <span className="text-gray-600">Full Coverage Insurance</span>
            ...
            <div className="flex mb-8">
              {[1, 2, 3].map((step) => (
                <div key={step} className="flex-1 flex flex-col items-center">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${bookingStep >= step ? 'bg-pink-500 text-white' : 'bg-gray-200 text-gray-500'}`}>
                    {step}
                  </div>
                  <span className={`text-xs ${bookingStep >= step ? 'text-pink-500 font-medium' : 'text-gray-500'}`}>
                    {step === 1 ? 'Details' : step === 2 ? 'Payment' : 'Confirmation'}
                  </span>
                  {step < 3 && (
                    <div className={`h-px w-full mt-4 ${bookingStep > step ? 'bg-pink-500' : 'bg-gray-200'}`}></div>
                  )}
                </div>
              ))}
            </div>
