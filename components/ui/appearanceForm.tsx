    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="space-y-4 mb-8">
        {paymentMethods.map((card) => (
          <div
            key={card.id}
            className="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300"
          >
      ...
      {!showAddForm ? (
        <button
          ...
          className="w-full border-2 border-dashed border-gray-300 rounded-xl p-8 hover:border-blue-500 hover:bg-blue-50 transition-all duration-300 group"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all cursor-text"
                />
              </div>
