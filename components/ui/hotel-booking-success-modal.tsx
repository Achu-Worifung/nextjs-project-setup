  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-full hover:bg-brand-gray-100 transition-colors z-10"
        >
        ...
        <div className="text-center p-6">
          ...
          {/* Success Message */}
          <h2 className="text-3xl font-bold text-brand-gray-900 mb-2">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 mb-6 text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-brand-gray-500" />
                <div>
              ...
              {/* Room Type */}
              <div className="flex items-center gap-3">
                <Bed className="w-5 h-5 text-brand-gray-500" />
                <div>
                  <p className="text-sm text-brand-gray-500">Room Type</p>
              ...
              {/* Check-in */}
              <div className="flex items-center gap-3">
                <Calendar className="w-5 h-5 text-brand-gray-500" />
                <div>
                  <p className="text-sm text-brand-gray-500">Check-in</p>
              ...
              <div className="flex items-center gap-3">
                <Calendar className="w-5 h-5 text-brand-gray-500" />
                <div>
                  <p className="text-sm text-brand-gray-500">Check-out</p>
            ...
            {booking.roomDescription && (
              <div className="mb-4">
                <p className="text-sm text-brand-gray-500 mb-1">Room Description</p>
                <p className="text-sm text-brand-gray-700">{booking.roomDescription}</p>
              </div>
            )}
            ...
            {booking.amenities && booking.amenities.length > 0 && (
              <div className="mb-4">
                <p className="text-sm text-brand-gray-500 mb-2">Amenities</p>
                <div className="flex flex-wrap gap-2">
                  {booking.amenities.slice(0, 6).map((amenity, index) => (
                    <span
                      key={index}
                      className="px-2 py-1 bg-brand-pink-100 text-blue-800 text-xs rounded-full"
                    >
                      {amenity}
                    </span>
                  ))}
                  {booking.amenities.length > 6 && (
                    <span className="px-2 py-1 bg-brand-gray-100 text-brand-gray-600 text-xs rounded-full">
            ...
            <div className="border-t pt-4 flex justify-between items-center">
              <span className="text-lg font-semibold text-brand-gray-900">Total Paid:</span>
          ...
          <div className="bg-brand-gray-50 rounded-lg p-4 mb-6">
            ...
            <p className="font-mono text-lg font-semibold text-brand-gray-900">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-brand-gray-500">
              ...
              <span className="text-brand-pink-600 font-medium">support@travelbook.com</span>
            </p>
          </div>
        </div>
      </div>
